...
def get_random_partitioned_train_loaders(N_partitions):
    ...
    index = 0
    index = fill_validation_set(train_dataset, validation_set, index)
    index = fill_random_set(train_dataset, paritioned_train_sets, partition_size, N_partitions, index)
...
def get_unbalanced_partitioned_train_loaders(N_partitions):
    ...
    index = 0
    index = fill_validation_set(train_dataset, validation_set, index)
    index = fill_unbalanced_set(train_dataset, paritioned_train_sets, total_size, N_partitions, partition_cutoffs, index)
